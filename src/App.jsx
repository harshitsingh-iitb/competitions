...
const competitions = [
  {
    name: "Code Clash 2025",
    description: "A high-speed algorithmic battle with $50,000 in prizes.",
    deadline: "July 31, 2025"
  },
  {
    name: "Cyber Defense Challenge",
    description: "Protect virtual infrastructure from sophisticated attacks.",
    deadline: "August 15, 2025"
  },
  {
    name: "AI Innovation Sprint",
    description: "Build the next breakthrough in artificial intelligence.",
    deadline: "September 10, 2025"
  },
  {
    name: "Data Science Derby",
    description: "Extract insights from complex datasets to solve real problems.",
    deadline: "August 28, 2025"
  },
  {
    name: "Quantum Computing Quest",
    description: "Harness quantum mechanics to solve impossible calculations.",
    deadline: "October 5, 2025"
  },
  {
    name: "Robotics Rumble",
    description: "Design and program autonomous robots for complex missions.",
    deadline: "September 22, 2025"
  },
  {
    name: "Blockchain Builder",
    description: "Create decentralized solutions for tomorrow's challenges.",
    deadline: "July 18, 2025"
  },
  {
    name: "Neural Network Nexus",
    description: "Push the boundaries of deep learning and machine intelligence.",
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
            8 elite challenges. One mission: win.
          </p>
